        ...
        <Paper className={'col-xs-12 col-md-12 col-lg-12 col-sm-12'}>
          ...
          >
            ...
            >
              ...
              <TableRow>
                <TableHeaderColumn colSpan={2}>{intl.formatMessage(messages.fullNameText)}</TableHeaderColumn>
                <TableHeaderColumn>
                  {intl.formatMessage(messages.quantity)}
                </TableHeaderColumn>
                <TableHeaderColumn>
                  {intl.formatMessage(messages.unitPrice, { theUnit: intl.formatMessage(messages.theUnit), price: intl.formatMessage(messages.price) })}
                </TableHeaderColumn>
                <TableHeaderColumn>
                ...
                >
                  ...
                  <TableRow>
                    <TableHeaderColumn>
                      <Subheader className={'text-center'}>
                        {intl.formatMessage(messages.total)}(
                        {intl.formatMessage(messages.afterDiscount)})
                      </Subheader>
                    </TableHeaderColumn>
                    <TableRowColumn>
                      <Subheader className={'text-center'}>
